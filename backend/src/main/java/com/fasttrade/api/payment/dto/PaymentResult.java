 ...
 *
 * ponytail: shape mínimo pro esqueleto — ajustar aos campos reais do Mercado Pago ao implementar.
 */
public record PaymentResult(
        String chargeId,      // id do pagamento no Mercado Pago (referência guardada no pedido)
